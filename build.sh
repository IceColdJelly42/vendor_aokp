...
source build/envsetup.sh && lunch icecold_endeavoru-userdebug
...
if [ "$1" != "" ]; then
    ...
    mv -f ${ZIP} ${ANDROID_PRODUCT_OUT}/icecold_endeavoru-ICJ-V"$1".zip
    ...
    mv -f ${SUM} ${ANDROID_PRODUCT_OUT}/icecold_endeavoru-ICJ-V"$1".zip.md5sum
